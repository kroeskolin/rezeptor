...
export default function AddRecipe({ onSave, onClose }) {
  ...
  const [youtubeNoRecipe, setYoutubeNoRecipe] = useState(null) // { title, description, imageBase64, sourceUrl }
  ...
  const handleUrlLoad = async () => {
    ...
    // … restlicher bestehender handleUrlLoad-Code bleibt unverändert …
